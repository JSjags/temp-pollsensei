    ...
    <AnimatePresence>
      ...
      <div className="flex flex-col justify-center items-center gap-10 ">
        <div className="text-center">
          ...
          <p className="text-lg">
          Provide a suitable title and description for the survey you want to create
          </p>
        </div>
        ...
        >
          <label htmlFor="">
            ...
            <input type="text" className="rounded-md py-2 px-3 border-[#BDBDBD] border w-full" placeholder="Enter Title of Survey here" 
      ...
      {surveyPrompt.length}/{maxCharacters} characters
          ...
          <ShadButton  disabled={!surveyPrompt && !manualSurveyTitle ? true : false} className="auth-btn" onClick={()=>{
