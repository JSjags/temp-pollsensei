...
//   useEffect(() => {
//     if (pollcoins && baseAmount && baseCoins) {
...
//       setPollAmount("");
//     }
//   }, [pollcoins, baseAmount, baseCoins, setPollAmount]);
...
//                 Today’s coin rate: ${baseAmount} / {baseCoins} pollcoins
//               </p>
//             )}
//           </div>
...
//         disabled={!pollAmount || !pollcoins || !baseAmount || !baseCoins}
//         variant="gradient"
...
export function BuyFirstStep() {
  ...
  const nairaAmount = 1500; // ₦1500
  const nairaCoins = 2000; // 2000 pollcoins
