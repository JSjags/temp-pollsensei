...
type RedeemableProps = {
  desc?: string;
};
export default function Redeemable({
  desc = "Your redeemable coins has not reached the transfer minimum of 50 coins. Refer friends to Earn more redeemable coins.",
}: RedeemableProps) {
  return (
    <Dialog.Body>
      <div className="flex items-center justify-center w-full flex-col gap-6">
        ...
        <div className="w-full text-center">
          <Button variant="gradient" className="rounded w-full">
            Earn more coins
          </Button>
          <Dialog.Close>
