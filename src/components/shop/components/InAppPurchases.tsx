...
import { Arrow, Purchases1, Purchases2 } from "@/assets/images";
  ...
  return (
    <div className="mt-10 flex-col gap-5 flex">
      <div className="mt-10 flex-col gap-5 flex max-md:px-5">
        ...
        <div className="flex md:items-stretch gap-[14px]">
          <div className="bg-[#FCFCFD] rounded-[11.72px] max-md:gap-6 w-fit py-2.5 border-[0.59px] flex flex-col justify-between">
            <div className="px-8">
