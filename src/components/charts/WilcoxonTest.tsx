...
const WilcoxonTestComponent: React.FC<TestProps> = (props) => {
  ...
  const hasResults = Object.keys(resultsObject).length > 0;

  const [selectedResult, setSelectedResult] = useState<string>(
    hasResults ? Object.keys(resultsObject)[0] : ""
  );

  const currentResult = hasResults ? resultsObject[selectedResult] : null;
