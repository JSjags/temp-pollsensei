...
//   const { data } = useReportOnboardState();

//   const { mutate, isPending, isSuccess, isError, error } = useUpdateOnboard();
...
//             <p>
//               Last Revised: April 16, 2025 Welcome to www.lorem-ipsum.info. This
...
//               Sites are provided solely as a convenience to our visitors. Such
//               Linked Sites are not under our control, and we are not responsible
//               for and does not endorse the content of such Linked Sites,
//               including any information or materials contained on such Linked
//               Sites. You will need to make your own independent judgment
//               regarding your interaction with these Linked Sites. 4. FORWARD
//               LOOKING STATEMENTS All materials reproduced on this site speak as
//               of the original date of publication or filing. The fact that a
...
//               SHALL BE AT YOUR SOLE RISK; (ii) THE SITE IS PROVIDED ON AN
//               &quot;AS IS&quot; AND &quot;AS AVAILABLE&quot; BASIS; (iii) EXCEPT
//               AS EXPRESSLY PROVIDED HEREIN WE DISCLAIM ALL WARRANTIES OF ANY
...
//               waiver, or otherwise. Without limiting the generality of the
//               foregoing, you acknowledge and agree that all content available
...
//               service marks, trade dress (collectively &quot;Trademarks&quot;)
...
//               for which we have made it available to you; (d) defame or
//               disparage us, our Trademarks, or any aspect of the Site; and (e)
//               adapt, translate, modify, decompile, disassemble, or reverse
...
//               form and by any method is expressly prohibited. 8. INDEMNITY By
//               using the Site web sites you agree to indemnify us and affiliated
//               entities (collectively &quot;Indemnities&quot;) and hold them
//               harmless from any and all claims and expenses, including (without
//               limitation) attorney&apos;s fees, arising from your use of the
...
//               person&apos;s use of any ID, membership or password you maintain
//               with any portion of the Site, regardless of whether such use is
//               authorized by you. 9. COPYRIGHT AND TRADEMARK NOTICE Except our
//               generated dummy copy, which is free to use for private and
...
//               including any terms and conditions on any of customer&apos;s
//               documents or purchase orders. B. No Joint Venture, No Derogation
//               of Rights. You agree that no joint venture, partnership,
...
export default function Terms() {
  ...
  const handleUpdate = () => {
    if (data?.data) {
      // Use existing data and only update accepted_terms to true
      const updatedData = {
        ...data.data,
      ...
      // Fallback: just send accepted_terms if no existing data
      mutate({ accepted_terms: true });
    }
  };
