...
interface AnswerSingleChoiceQuestionProps {
  question: string;
  questionType: string;
  options: string[];
...
const AnswerSingleChoiceQuestion: React.FC<AnswerSingleChoiceQuestionProps> = ({
  question,
  options,
  selectedOptions,
  questionType,
...
export default AnswerSingleChoiceQuestion;
