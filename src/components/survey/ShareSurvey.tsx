...
import { useDownloadPDFQuery, useShareSurveyQuery, useLazyShareSurveyQuery } from "@/services/survey.service";
...
const ShareSurvey: React.FC<ShareSurveyProps> = ({onClick, _id}) => {
  ...
  const [shareLazyLink, { data:shareLazyData ,isLoading: shareLoading }] = useLazyShareSurveyQuery()
